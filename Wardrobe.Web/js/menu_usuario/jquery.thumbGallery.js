...
(function($) {
	...
	function ThumbGallery(element, options) {
		...
		if(!this.isMobile) this.isMobile = (/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent));//recheck
		//this.isMobile=true;
		...
		$('.thumb_hidden').stop().animate({ 'opacity': 1},  {duration: 500, easing: 'easeOutSine'});//show thumbnails
